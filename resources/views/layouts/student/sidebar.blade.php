<aside class="w-64 bg-white border-r border-gray-200 hidden md:block">
            <nav class="mt-6 px-4 space-y-2">
                ...
                <a href="{{ route('student.courses.index') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-lg transition">
                ...
                <div class="pt-4 pb-2">
                    <p class="px-4 text-xs font-bold text-gray-400 uppercase tracking-wider">Profile</p>
                </div>

                <a href="#" onclick="showProfileModal(); return false;" class="flex items-center space-x-3 px-4 py-3 text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-lg transition">
                    <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
