        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
            <form action="{{ route('student.profile.update') }}" method="POST">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-blue-50 p-4 rounded-lg border border-blue-100">
                            <p class="text-xs font-bold text-blue-600 uppercase mb-2">University Record</p>
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <p class="text-xs text-gray-500">Matric Number</p>
                                    <p class="text-sm font-bold text-gray-900">{{ auth()->user()->profile->matric_number ?? 'Not Set' }}</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500">Programme</p>
                                    <p class="text-sm font-bold text-gray-900 leading-tight">{{ auth()->user()->profile->programme ?? 'Not Set' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="phone_number" value="{{ auth()->user()->profile->phone_number ?? '' }}" 
                        ...
                        <div>
                            ...
                            <textarea name="address" rows="3" 
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">{{ auth()->user()->profile->address ?? '' }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    ...
                    <button type="button" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm" onclick="closeModal('profileModal')">
                        Cancel
                    </button>
                </div>
            </form>
